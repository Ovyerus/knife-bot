...
const userFriendlyHelpers = {
    /**
     * Easy method for checking if a string has a similar meaning to enable.
     * 
     * @param {String} str String to check.
     * @returns {Boolean} Whether the string has a similar meaning to enable.
     */
    isEnable(str) {
        return ['enable', 'true', 'on', 'activate', 'active', 'turn on', 'allow', 'yes', 'y'].includes(str.toLowerCase());
    },

    /**
     * Easy method for checking is a string has a similar meaning to disable.
     * 
     * @param {String} str String to check.
     * @returns {Boolean} Whether the string has a similar meaning to disable.
     */
    isDisable(str) {
        return ['disable', 'false', 'off', 'deactivate', 'inactive', 'turn off', 'disallow', 'no', 'n'].includes(str.toLowerCase());
    }
};

module.exports = {AwaitTimeout, ValueError, formatUTC, LCG, inviteRegex, URLRegex, getLinkRedirects, userFriendlyHelpers};